...
/**
    ...
    * @enum {string}
    */
export declare enum TransferEventListRequestDirectionEnum {
    Inbound = "inbound",
    Outbound = "outbound",
    Null = "null"
}
...
/**
    ...
    * @enum {string}
    */
export declare enum TransferReceiverDetailsAvailableBalanceEnum {
    Positive = "positive",
    Negative = "negative",
    Null = "null"
}
...
export declare const PlaidApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    incomeVerificationPaystubGet(incomeVerificationPaystubGetRequest: IncomeVerificationPaystubGetRequest, options?: any): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<void>>;
    /**
     * `/income/verification/paystubs/get` returns the information collected from the paystubs that were used to verify an end user\'s income. It can be called once the status of the verification has been set to `VERIFICATION_STATUS_PROCESSING_COMPLETE`, as reported by the `INCOME: verification_status` webhook. Attempting to call the endpoint before verification has been completed will result in an error.
     * @summary Retrieve information from the paystubs used for income verification
     * @param {IncomeVerificationPaystubsGetRequest} incomeVerificationPaystubsGetRequest
    ...
    signalEvaluate(requestBody: {
        [key: string]: object;
    }, options?: any): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<SignalEvaluateResponse>>;
    /**
     * Call the `/signal/return/report` endpoint to report a returned transaction that was previously sent to the `/signal/evaluate` endpoint. Your feedback will be used by the model to incorporate the latest risk trend in your portfolio.
     * @summary Report a return for an ACH transaction
     * @param {SignalReturnReportRequest} signalReturnReportRequest
...
export declare const PlaidApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
    ...
    signalEvaluate(requestBody: {
        [key: string]: object;
    }, options?: any): AxiosPromise<SignalEvaluateResponse>;
    /**
     * Call the `/signal/return/report` endpoint to report a returned transaction that was previously sent to the `/signal/evaluate` endpoint. Your feedback will be used by the model to incorporate the latest risk trend in your portfolio.
     * @summary Report a return for an ACH transaction
     * @param {SignalReturnReportRequest} signalReturnReportRequest
...
export declare class PlaidApi extends BaseAPI {
     ...
     * @memberof PlaidApi
     */
    incomeVerificationPaystubGet(incomeVerificationPaystubGetRequest: IncomeVerificationPaystubGetRequest, options?: any): Promise<import("axios").AxiosResponse<void>>;
    /**
     * `/income/verification/paystubs/get` returns the information collected from the paystubs that were used to verify an end user\'s income. It can be called once the status of the verification has been set to `VERIFICATION_STATUS_PROCESSING_COMPLETE`, as reported by the `INCOME: verification_status` webhook. Attempting to call the endpoint before verification has been completed will result in an error.
     * @summary Retrieve information from the paystubs used for income verification
     * @param {IncomeVerificationPaystubsGetRequest} incomeVerificationPaystubsGetRequest
    ...
    signalEvaluate(requestBody: {
        [key: string]: object;
    }, options?: any): Promise<import("axios").AxiosResponse<SignalEvaluateResponse>>;
    /**
     * Call the `/signal/return/report` endpoint to report a returned transaction that was previously sent to the `/signal/evaluate` endpoint. Your feedback will be used by the model to incorporate the latest risk trend in your portfolio.
     * @summary Report a return for an ACH transaction
     * @param {SignalReturnReportRequest} signalReturnReportRequest
