...
export interface LinkTokenCreateRequestAuth {
     ...
     */
    auth_flow: LinkTokenCreateRequestAuthAuthFlowEnum;
}
/**
    * @export
    * @enum {string}
    */
export declare enum LinkTokenCreateRequestAuthAuthFlowEnum {
...
export declare const PlaidApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    employersSearch: (employersSearchRequest?: EmployersSearchRequest | undefined, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    incomeVerificationDocumentsDownload: (incomeVerificationDocumentsDownloadRequest?: IncomeVerificationDocumentsDownloadRequest | undefined, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    incomeVerificationPaystubGet: (incomeVerificationPaystubGetRequest?: IncomeVerificationPaystubGetRequest | undefined, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    incomeVerificationSummaryGet: (incomeVerificationSummaryGetRequest?: IncomeVerificationSummaryGetRequest | undefined, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    postIncomeVerificationCreate: (incomeVerificationCreateRequest?: IncomeVerificationCreateRequest | undefined, options?: any) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    sandboxProcessorTokenCreate: (sandboxProcessorTokenCreateRequest?: SandboxProcessorTokenCreateRequest | undefined, options?: any) => Promise<RequestArgs>;
    /**
...
export declare const PlaidApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    employersSearch(employersSearchRequest?: EmployersSearchRequest | undefined, options?: any): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<EmployersSearchResponse>>;
    /**
     * The `/identity/get` endpoint allows you to retrieve various account holder information on file with the financial institution, including names, emails, phone numbers, and addresses. Only name data is guaranteed to be returned; other fields will be empty arrays if not provided by the institution.  Note: This request may take some time to complete if identity was not specified as an initial product when creating the Item. This is because Plaid must communicate directly with the institution to retrieve the data.
     * @summary Retrieve identity data
     * @param {IdentityGetRequest} identityGetRequest
     ...
     * @throws {RequiredError}
     */
    incomeVerificationDocumentsDownload(incomeVerificationDocumentsDownloadRequest?: IncomeVerificationDocumentsDownloadRequest | undefined, options?: any): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<any>>;
    /**
     * `/income/verification/paystub/get` returns the information collected from the paystub that was used to verify an end user\'s income. It can be called once the status of the verification has been set to `VERIFICATION_STATUS_PROCESSING_COMPLETE`, as reported by the `INCOME: verification_status` webhook. Attempting to call the endpoint before verification has been completed will result in an error.
     * @summary Retrieve information from the paystub used for income verification
     * @param {IncomeVerificationPaystubGetRequest} [incomeVerificationPaystubGetRequest]
     ...
     * @throws {RequiredError}
     */
    incomeVerificationPaystubGet(incomeVerificationPaystubGetRequest?: IncomeVerificationPaystubGetRequest | undefined, options?: any): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<IncomeVerificationPaystubGetResponse>>;
    /**
     * `/income/verification/summary/get` returns a verification summary for the income that was verified for an end user. It can be called once the status of the verification has been set to `VERIFICATION_STATUS_PROCESSING_COMPLETE`, as reported by the `INCOME: verification_status` webhook. Attempting to call the endpoint before verification has been completed will result in an error.
     * @summary Retrieve a summary of information derived from income verification
     * @param {IncomeVerificationSummaryGetRequest} [incomeVerificationSummaryGetRequest]
     ...
     * @throws {RequiredError}
     */
    incomeVerificationSummaryGet(incomeVerificationSummaryGetRequest?: IncomeVerificationSummaryGetRequest | undefined, options?: any): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<IncomeVerificationSummaryGetResponse>>;
    /**
     * Returns a JSON response containing details on all financial institutions currently supported by Plaid. Because Plaid supports thousands of institutions, results are paginated.  This data changes frequently. If you store it locally on your system, be sure to update it regularly.
     * @summary Get details of all supported institutions
     * @param {InstitutionsGetRequest} institutionsGetRequest
     ...
     * @throws {RequiredError}
     */
    postIncomeVerificationCreate(incomeVerificationCreateRequest?: IncomeVerificationCreateRequest | undefined, options?: any): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<IncomeVerificationCreateResponse>>;
    /**
     * Used to create a token suitable for sending to Apex to enable Plaid-Apex integrations.
     * @summary Create Apex bank account token
     * @param {ProcessorApexProcessorTokenCreateRequest} processorApexProcessorTokenCreateRequest
     ...
     * @throws {RequiredError}
     */
    sandboxProcessorTokenCreate(sandboxProcessorTokenCreateRequest?: SandboxProcessorTokenCreateRequest | undefined, options?: any): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<SandboxProcessorTokenCreateResponse>>;
    /**
     * Use the `/sandbox/public_token/create`  endpoint to create a valid `public_token`  for an arbitrary institution ID, initial products, and test credentials. The created `public_token` maps to a new Sandbox Item. You can then call `/item/public_token/exchange` to exchange the `public_token` for an `access_token` and perform all API actions. `/sandbox/public_token/create` can also be used with the [`user_custom` test username](/docs/sandbox/user-custom) to generate a test account with custom data.
     * @summary Create a test Item
     * @param {SandboxPublicTokenCreateRequest} sandboxPublicTokenCreateRequest
...
export declare const PlaidApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    employersSearch(employersSearchRequest?: EmployersSearchRequest | undefined, options?: any): AxiosPromise<EmployersSearchResponse>;
    /**
     * The `/identity/get` endpoint allows you to retrieve various account holder information on file with the financial institution, including names, emails, phone numbers, and addresses. Only name data is guaranteed to be returned; other fields will be empty arrays if not provided by the institution.  Note: This request may take some time to complete if identity was not specified as an initial product when creating the Item. This is because Plaid must communicate directly with the institution to retrieve the data.
     * @summary Retrieve identity data
     * @param {IdentityGetRequest} identityGetRequest
     ...
     * @throws {RequiredError}
     */
    incomeVerificationDocumentsDownload(incomeVerificationDocumentsDownloadRequest?: IncomeVerificationDocumentsDownloadRequest | undefined, options?: any): AxiosPromise<any>;
    /**
     * `/income/verification/paystub/get` returns the information collected from the paystub that was used to verify an end user\'s income. It can be called once the status of the verification has been set to `VERIFICATION_STATUS_PROCESSING_COMPLETE`, as reported by the `INCOME: verification_status` webhook. Attempting to call the endpoint before verification has been completed will result in an error.
     * @summary Retrieve information from the paystub used for income verification
     * @param {IncomeVerificationPaystubGetRequest} [incomeVerificationPaystubGetRequest]
     ...
     * @throws {RequiredError}
     */
    incomeVerificationPaystubGet(incomeVerificationPaystubGetRequest?: IncomeVerificationPaystubGetRequest | undefined, options?: any): AxiosPromise<IncomeVerificationPaystubGetResponse>;
    /**
     * `/income/verification/summary/get` returns a verification summary for the income that was verified for an end user. It can be called once the status of the verification has been set to `VERIFICATION_STATUS_PROCESSING_COMPLETE`, as reported by the `INCOME: verification_status` webhook. Attempting to call the endpoint before verification has been completed will result in an error.
     * @summary Retrieve a summary of information derived from income verification
     * @param {IncomeVerificationSummaryGetRequest} [incomeVerificationSummaryGetRequest]
     ...
     * @throws {RequiredError}
     */
    incomeVerificationSummaryGet(incomeVerificationSummaryGetRequest?: IncomeVerificationSummaryGetRequest | undefined, options?: any): AxiosPromise<IncomeVerificationSummaryGetResponse>;
    /**
     * Returns a JSON response containing details on all financial institutions currently supported by Plaid. Because Plaid supports thousands of institutions, results are paginated.  This data changes frequently. If you store it locally on your system, be sure to update it regularly.
     * @summary Get details of all supported institutions
     * @param {InstitutionsGetRequest} institutionsGetRequest
     ...
     * @throws {RequiredError}
     */
    postIncomeVerificationCreate(incomeVerificationCreateRequest?: IncomeVerificationCreateRequest | undefined, options?: any): AxiosPromise<IncomeVerificationCreateResponse>;
    /**
     * Used to create a token suitable for sending to Apex to enable Plaid-Apex integrations.
     * @summary Create Apex bank account token
     * @param {ProcessorApexProcessorTokenCreateRequest} processorApexProcessorTokenCreateRequest
     ...
     * @throws {RequiredError}
     */
    sandboxProcessorTokenCreate(sandboxProcessorTokenCreateRequest?: SandboxProcessorTokenCreateRequest | undefined, options?: any): AxiosPromise<SandboxProcessorTokenCreateResponse>;
    /**
     * Use the `/sandbox/public_token/create`  endpoint to create a valid `public_token`  for an arbitrary institution ID, initial products, and test credentials. The created `public_token` maps to a new Sandbox Item. You can then call `/item/public_token/exchange` to exchange the `public_token` for an `access_token` and perform all API actions. `/sandbox/public_token/create` can also be used with the [`user_custom` test username](/docs/sandbox/user-custom) to generate a test account with custom data.
     * @summary Create a test Item
     * @param {SandboxPublicTokenCreateRequest} sandboxPublicTokenCreateRequest
