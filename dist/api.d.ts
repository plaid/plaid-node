...
export interface ProcessorTokenCreateRequest {
    ...
    account_id: string;
    /**
     * The processor you are integrating with. Valid values are `\"achq\"`, `\"checkbook\"`, `\"circle\"`, `\"drivewealth\"`, `\"dwolla\"`, `\"galileo\"`, \"`interactive_brokers`\", `\"modern_treasury\"`, `\"ocrolus\"`, `\"prime_trust\"`, `\"velox\"`, `\"vesta\"`, `\"vopay\"`
     * @type {string}
     * @memberof ProcessorTokenCreateRequest
     */
    processor: string;
