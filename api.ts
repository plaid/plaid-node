...
/**
    ...
    * @enum {string}
    */
export enum LinkTokenCreateRequestAuthAuthFlowEnum {
...
export const PlaidApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        postIncomeVerificationCreate: async (incomeVerificationCreateRequest?: IncomeVerificationCreateRequest, options: any = {}): Promise<RequestArgs> => {
...
export const PlaidApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async postIncomeVerificationCreate(incomeVerificationCreateRequest?: IncomeVerificationCreateRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IncomeVerificationCreateResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.postIncomeVerificationCreate(incomeVerificationCreateRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Used to create a token suitable for sending to Apex to enable Plaid-Apex integrations.
...
export const PlaidApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        postIncomeVerificationCreate(incomeVerificationCreateRequest?: IncomeVerificationCreateRequest, options?: any): AxiosPromise<IncomeVerificationCreateResponse> {
            return localVarFp.postIncomeVerificationCreate(incomeVerificationCreateRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * Used to create a token suitable for sending to Apex to enable Plaid-Apex integrations.
         * @summary Create Apex bank account token
...
export class PlaidApi extends BaseAPI {
     ...
     * @memberof PlaidApi
     */
    public postIncomeVerificationCreate(incomeVerificationCreateRequest?: IncomeVerificationCreateRequest, options?: any) {
        return PlaidApiFp(this.configuration).postIncomeVerificationCreate(incomeVerificationCreateRequest, options).then((request) => request(this.axios, this.basePath));
    }
