...
Client.prototype.createLinkToken =
  function(options, cb) {
    return this._authenticatedRequest({
      ...
      body: {
        user: helpers.processUserFields(options.user).user,
        ...
        link_customization_name: options.link_customization_name,
        redirect_uri: options.redirect_uri,
        android_package_name: options.android_package_name,
        institution_id: options.institution_id,
        account_filters: options.account_filters,
        cross_app_item_add: options.cross_app_item_add,
        payment_initiation: options.payment_initiation,
      },
    }, cb);
  };
