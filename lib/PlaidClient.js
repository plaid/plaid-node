...
Client.prototype.createPublicToken = function(access_token, options, cb) {
  createPublicTokenRequest = requestWithAccessToken('/item/public_token/create', false)
  console.warn("Warning: this method will be deprecated in a future version. To replace the public_token for initializing Link, look into the link_token at https://plaid.com/docs/api/tokens/#linktokencreate.");
  return createPublicTokenRequest(access_token, options, cb);
};
...
Client.prototype.createPaymentToken =	
  function(payment_id, cb) {	
    console.warn("Warning: this method will be deprecated in a future version. To replace the payment_token, look into the link_token at https://plaid.com/docs/api/tokens/#linktokencreate.");
