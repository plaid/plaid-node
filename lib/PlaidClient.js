...
const plaidEnvironments = require('./plaidEnvironments.js');
const plaidRequest = require('./plaidRequest.js');
...
// Private
const requestWithAccessToken = function(path) {
...
Client.prototype._authenticatedRequest =
  function _authenticatedRequest(requestSpec, options, cb, withPublicKey) {
    ...
    const context = R.merge({env: this.env}, withPublicKey ? {
