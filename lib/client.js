...
Client.prototype.step = function (credentials, access_token, options, callback) {
...
Client.prototype._exec = function (callback){
  ...
  var uri = this.config.protocol + this.config.host + this.config.endpoint;
...
Client.prototype._handleSuccess = function(callback){
  ...
  return callback(null, this.body, false);
}
...
Client.prototype._handleMFA = function(callback){
  ...
  this.body.message.html = html;

  return callback(null, this.body.message, true)
}
