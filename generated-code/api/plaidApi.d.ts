...
export declare class PlaidApi {
    ...
    itemPublicTokenCreate(itemPublicTokenCreateRequest: ItemPublicTokenCreateRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: ItemPublicTokenCreateResponse;
    }>;
    ...
    paymentInitiationRecipientList(paymentInitiationRecipientListResponse: PaymentInitiationRecipientListResponse, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
