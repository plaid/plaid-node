...
export interface LinkTokenGetMetadataResponse {
     ...
     * @memberof LinkTokenGetMetadataResponse
     */
    account_filters?: LinkTokenCreateRequestAccountSubtypes;
    /**
...
export interface ProcessorNumber {
     ...
     * @memberof ProcessorNumber
     */
    international?: NumbersInternational | null;
    /**
     *
     * @type {NumbersBACS}
     * @memberof ProcessorNumber
     */
    bacs?: NumbersBACS | null;
}
/**
...
export declare const PlaidApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    paymentIntiationPaymentGet: (paymentInitiationPaymentGetRequest: PaymentInitiationPaymentGetRequest, options?: any) => Promise<RequestArgs>;
    /**
...
export declare const PlaidApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    paymentIntiationPaymentGet(paymentInitiationPaymentGetRequest: PaymentInitiationPaymentGetRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaymentInitiationPaymentGetResponse>>;
    /**
     * Used to create a token suitable for sending to Apex to enable Plaid-Apex integrations.
     * @summary Create Apex bank account token
     * @param {ProcessorApexProcessorTokenCreateRequest} processorApexProcessorTokenCreateRequest
...
export declare const PlaidApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    paymentIntiationPaymentGet(paymentInitiationPaymentGetRequest: PaymentInitiationPaymentGetRequest, options?: any): AxiosPromise<PaymentInitiationPaymentGetResponse>;
    /**
     * Used to create a token suitable for sending to Apex to enable Plaid-Apex integrations.
     * @summary Create Apex bank account token
     * @param {ProcessorApexProcessorTokenCreateRequest} processorApexProcessorTokenCreateRequest
...
export declare class PlaidApi extends BaseAPI {
     ...
     * @memberof PlaidApi
     */
    paymentIntiationPaymentGet(paymentInitiationPaymentGetRequest: PaymentInitiationPaymentGetRequest, options?: any): Promise<import("axios").AxiosResponse<PaymentInitiationPaymentGetResponse>>;
    /**
     * Used to create a token suitable for sending to Apex to enable Plaid-Apex integrations.
     * @summary Create Apex bank account token
     * @param {ProcessorApexProcessorTokenCreateRequest} processorApexProcessorTokenCreateRequest
