...
/**
 * A set of fields describing the balance for an account. Available and current balance information may be cached and is not guaranteed to be up-to-date in realtime unless the balance object was returned by `/accounts/balance/get`.
 * @export
...
/**
 * BalanceGetRequest defines the request schema for `/accounts/balance/get`
 * @export
...
/**
 * BalanceGetResponse defines the response schema for `/accounts/balance/get`
 * @export
...
export interface BankTransferCreateRequest {
    ...
    iso_currency_code: string;
    /**
     * The transfer description. Maximum of 8 characters.
     * @type {string}
     * @memberof BankTransferCreateRequest
     */
    description: string;
...
export interface BankTransferEventListRequest {
    ...
    secret: string;
    /**
     * The start date of bank transfers to list, as ISO8601 datetime (YYYY-MM-DD).
     * @type {string}
     * @memberof BankTransferEventListRequest
     */
    start_date?: string;
    /**
     * The end date of bank transfers to list, as ISO8601 datetime (YYYY-MM-DD).
     * @type {string}
     * @memberof BankTransferEventListRequest
     */
    end_date?: string;
...
export interface BankTransferFailure {
    /**
     * The ACH return code, e.g. `R01`.  For a full listing of ACH return codes, see [Bank Transfers errors](/docs/errors/bank-transfers/#ach-return-codes).
     * @type {string}
...
export interface BankTransferListRequest {
    ...
    secret: string;
    /**
     * The start datetime of bank transfers to list. This should be of the form `2006-01-02T15:04:05Z`.
     * @type {string}
     * @memberof BankTransferListRequest
     */
    start_date?: string;
    /**
     * The end datetime of bank transfers to list. This should be of the form `2006-01-02T15:04:05Z`.
     * @type {string}
     * @memberof BankTransferListRequest
     */
    end_date?: string;
...
/**
 * InstitutionSearchRequest defines the request schema for `/institutions/search`
 * @export
...
/**
 * InstitutionSearchResponse defines the response schema for `/institutions/search`
 * @export
...
export interface LinkTokenCreateRequest {
    ...
    webhook?: string;
    /**
     * The `access_token` associated with the Item to update, used when updating or modifying an existing `access_token`. Used when launching Link in update mode or (optionally) when initializing Link as part of the Payment Initiation (Europe) flow.
     * @type {string}
     * @memberof LinkTokenCreateRequest
     */
    access_token?: string;
...
export interface MortgageLiability {
    ...
    /**
     * Type of mortgage (i.e. `conventional`, `fixed`, `variable`).
     * @type {string}
     * @memberof MortgageLiability
     */
     ...
     * @memberof MortgageLiability
     */
    next_monthly_payment_amount?: number | null;
    /**
...
/**
 * PaymentIntiationPaymentGetRequest defines the request schema for `/payment_initiation/payment/get`
 * @export
...
/**
 * PaymentIntiationPaymentGetResponse defines the response schema for `/payment_initation/payment/get`
 * @export
...
export interface PaymentIntiationPaymentGetResponse {
     ...
     * @memberof PaymentIntiationPaymentGetResponse
     */
    status?: PaymentIntiationPaymentGetResponseStatusEnum;
    /**
     * The ID of the recipient
     * @type {string}
     * @memberof PaymentIntiationPaymentGetResponse
...
/**
    ...
    * @enum {string}
    */
export declare enum PaymentIntiationPaymentGetResponseStatusEnum {
    INPUTNEEDED = "PAYMENT_STATUS_INPUT_NEEDED",
    PROCESSING = "PAYMENT_STATUS_PROCESSING",
    INITIATED = "PAYMENT_STATUS_INITIATED",
    COMPLETED = "PAYMENT_STATUS_COMPLETED",
...
export interface PaymentIntiationPaymentGetResponseSchedule {
     ...
     */
    interval: PaymentIntiationPaymentGetResponseScheduleIntervalEnum;
    /**
     * The day of the interval on which to schedule the payment.  If the payment interval is weekly, `interval_execution_day` should be an integer from 1 (Monday) to 7 (Sunday).  If the payment interval is monthly, `interval_execution_day` should be an integer indicating which day of the month to make the payment on. Integers from 1 to 28 can be used to make a payment on that day of the month. Negative integers from -1 to -5 can be used to make a payment relative to the end of the month. To make a payment on the last day of the month, use -1; to make the payment on the second-to-last day, use -2, and so on.
     * @type {number}
     * @memberof PaymentIntiationPaymentGetResponseSchedule
...
/**
    ...
    * @enum {string}
    */
export declare enum PaymentIntiationPaymentGetResponseScheduleIntervalEnum {
    WEEKLY = "WEEKLY",
    MONTHLY = "MONTHLY"
}
/**
...
export interface ProcessorTokenCreateRequest {
    ...
    account_id: string;
    /**
     * The processor you are integrating with. Valid values are `\"achq\"`, `\"check\"` , `\"checkbookio\"` , `\"circle\"` , `\"drivewealth\"`, `\"dwolla\"`, `\"galileo\"`, \"`interactive_brokers`\", `\"modern_treasury\"`, `\"ocrolus\"`, `\"paypayapay\"`, `\"prime_trust\"`, `\"sila_money\"` , `\"velox\"`, `\"vesta\"`, `\"vopay\"`
     * @type {string}
     * @memberof ProcessorTokenCreateRequest
     */
    processor: string;
...
export interface WebhookVerificationKeyGetResponse {
    /**
     *
     * @type {WebhookVerificationKeyGetResponseKey}
 ...
 * @export
 * @interface WebhookVerificationKeyGetResponseKey
 */
export interface WebhookVerificationKeyGetResponseKey {
    /**
     * The alg member identifies the cryptographic algorithm family used with the key.
     * @type {string}
     * @memberof WebhookVerificationKeyGetResponseKey
     */
    alg?: string;
    /**
