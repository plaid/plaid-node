...
import { AccountsGetResponse, Amount, AssetReportAuditCopyCreateResponse, AssetReportAuditCopyRemoveResponse, AssetReportCreateRequestOptions, AssetReportCreateResponse, AssetReportFilterResponse, AssetReportGetResponse, AssetReportRefreshRequestOptions, AssetReportRefreshResponse, AssetReportRemoveResponse, AuthGetRequestOptions, AuthGetResponse, BalanceGetRequestOptions, BalanceGetResponse, CategoriesGetResponse, DepositSwitchCreateResponse, DepositSwitchGetResponse, DepositSwitchTokenCreateResponse, IdentityGetResponse, InstitutionSearchRequestOptions, InstitutionSearchResponse, InstitutionsGetByIdRequestOptions, InstitutionsGetByIdResponse, InstitutionsGetRequestOptions, InstitutionsGetResponse, InvestmentsHoldingsGetRequest, InvestmentsHoldingsGetRequestOptions, InvestmentsTransactionsGetRequestOptions, InvestmentsTransactionsGetResponse, ItemAccessTokenInvalidateResponse, ItemGetResponse, ItemImportRequestOptions, ItemImportRequestUserAuth, ItemImportResponse, ItemPublicTokenExchangeResponse, ItemRemoveResponse, ItemWebhookUpdateResponse, LiabilitiesGetRequestOptions, LiabilitiesGetResponse, LinkTokenCreateRequest, LinkTokenCreateResponse, PaymentInitiationAddress, PaymentInitiationPaymentCreateRequestSchedule, PaymentInitiationPaymentCreateResponse, PaymentInitiationPaymentListResponse, PaymentInitiationRecipientCreateRequestBacs, PaymentInitiationRecipientCreateResponse, PaymentInitiationRecipientGetResponse, PaymentIntiationPaymentGetResponse, PlaidApi, ProcessorAuthGetResponse, ProcessorBalanceGetResponse, ProcessorIdentityGetResponse, ProcessorStripeBankAccountTokenCreateResponse, ProcessorTokenCreateResponse, SandboxItemFireWebhookRequest, SandboxItemFireWebhookResponse, SandboxItemResetLoginResponse, SandboxItemSetVerificationStatusResponse, SandboxPublicTokenCreateRequestOptions, SandboxPublicTokenCreateResponse, TransactionsGetRequestOptions, TransactionsGetResponse, TransactionsRefreshResponse, WebhookVerificationKeyGetResponse } from './generated-code/api';
...
declare class Client {
    ...
    getInstitutionById(institution_id: string, options?: InstitutionsGetByIdRequestOptions, cb?: Callback<InstitutionsGetByIdResponse>): Promise<InstitutionsGetByIdResponse>;
    getInstitutions(count: number, offset: number, options?: InstitutionsGetRequestOptions, cb?: Callback<InstitutionsGetResponse>): Promise<InstitutionsGetResponse>;
    ...
    sandboxItemFireWebhook(access_token: string, webhook_code: SandboxItemFireWebhookRequest.WebhookCodeEnum, cb?: Callback<SandboxItemFireWebhookResponse>): Promise<SandboxItemFireWebhookResponse>;
...
declare const plaidRequest: (request: Promise<{
    response: http.IncomingMessage;
    body: any;
}>, cb?: Callback<any> | undefined) => any;
