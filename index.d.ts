...
declare class Client {
    ...
    searchInstitutionsByName(query: string, products: Array<Products>, country_codes: Array<CountryCode>, options?: InstitutionsSearchRequestOptions, cb?: Callback<InstitutionSearchResponse>): Promise<InstitutionSearchResponse>;
