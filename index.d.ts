...
declare class Client {
    ...
    searchInstitutionsByName(query: string, products: Array<string>, country_codes: Array<CountryCode>, options?: InstitutionSearchRequestOptions, cb?: Callback<InstitutionSearchResponse>): Promise<InstitutionSearchResponse>;
