...
import { AccountsGetRequestOptions, AccountsGetResponse, Amount, AssetReportAuditCopyCreateResponse, AssetReportAuditCopyRemoveResponse, AssetReportCreateRequestOptions, AssetReportCreateResponse, AssetReportFilterResponse, AssetReportGetResponse, AssetReportRefreshRequestOptions, AssetReportRefreshResponse, AssetReportRemoveResponse, AuthGetRequestOptions, AuthGetResponse, BankTransferBalanceGetResponse, BankTransferCancelResponse, BankTransferCreateRequest, BankTransferCreateResponse, BankTransferEventListRequest, BankTransferEventListResponse, BankTransferEventSyncResponse, BankTransferEventType, BankTransferFailure, BankTransferGetResponse, BankTransferListRequest, BankTransferListResponse, BankTransferMigrateAccountResponse, CategoriesGetResponse, CountryCode, DepositSwitchCreateResponse, DepositSwitchGetResponse, DepositSwitchTokenCreateResponse, ExternalPaymentSchedule, IdentityGetResponse, InstitutionsSearchRequestOptions, InstitutionsSearchResponse, InstitutionsGetByIdRequestOptions, InstitutionsGetByIdResponse, InstitutionsGetRequestOptions, InstitutionsGetResponse, InvestmentsHoldingsGetRequest, InvestmentHoldingsGetRequestOptions, InvestmentsTransactionsGetRequestOptions, InvestmentsTransactionsGetResponse, ItemAccessTokenInvalidateResponse, ItemGetResponse, ItemImportRequestOptions, ItemImportRequestUserAuth, ItemImportResponse, ItemPublicTokenExchangeResponse, ItemRemoveResponse, ItemWebhookUpdateResponse, LiabilitiesGetRequestOptions, LiabilitiesGetResponse, LinkTokenCreateRequest, LinkTokenCreateResponse, LinkTokenGetResponse, PaymentInitiationAddress, PaymentInitiationPaymentCreateResponse, PaymentInitiationPaymentListResponse, PaymentInitiationRecipientCreateResponse, PaymentInitiationRecipientGetResponse, PaymentInitiationPaymentGetResponse, PlaidApi, ProcessorAuthGetResponse, ProcessorBalanceGetResponse, ProcessorIdentityGetResponse, ProcessorStripeBankAccountTokenCreateResponse, ProcessorTokenCreateResponse, Products, RecipientBACS, SandboxBankTransferSimulateResponse, SandboxItemFireWebhookRequestWebhookCodeEnum, SandboxItemFireWebhookResponse, SandboxItemResetLoginResponse, SandboxItemSetVerificationStatusResponse, SandboxPublicTokenCreateRequestOptions, SandboxPublicTokenCreateResponse, SandboxItemSetVerificationStatusRequestVerificationStatusEnum, TransactionsGetRequestOptions, TransactionsGetResponse, TransactionsRefreshResponse, WebhookVerificationKeyGetResponse } from './generated-code';
...
declare class Client {
    ...
    bankTransferBalanceGet(origination_account_id?: string, cb?: Callback<BankTransferBalanceGetResponse>): Promise<BankTransferBalanceGetResponse>;
    bankTransferCancel(bank_transfer_id: string, cb?: Callback<BankTransferCancelResponse>): Promise<BankTransferCancelResponse>;
    bankTransferCreate(options: BankTransferCreateRequest, cb?: Callback<BankTransferCreateResponse>): Promise<BankTransferCreateResponse>;
    bankTransferEventList(options: BankTransferEventListRequest, cb?: Callback<BankTransferEventListResponse>): Promise<BankTransferEventListResponse>;
    bankTransferEventSync(after_id: number, count?: number, cb?: Callback<BankTransferEventSyncResponse>): Promise<BankTransferEventSyncResponse>;
    bankTransferGet(bank_transfer_id: string, cb?: Callback<BankTransferGetResponse>): Promise<BankTransferGetResponse>;
    bankTransferList(options: BankTransferListRequest, cb?: Callback<BankTransferListResponse>): Promise<BankTransferListResponse>;
    bankTransferMigrateAccount(account_number: string, routing_number: string, account_type: string, cb?: Callback<BankTransferMigrateAccountResponse>): Promise<BankTransferMigrateAccountResponse>;
    createAssetReport(access_tokens: Set<string>, days_requested: number, options?: AssetReportCreateRequestOptions, cb?: Callback<AssetReportCreateResponse>): Promise<AssetReportCreateResponse>;
    ...
    createPayment(recipient_id: string, reference: string, amount: Amount, schedule?: ExternalPaymentSchedule, cb?: Callback<PaymentInitiationPaymentCreateResponse>): Promise<PaymentInitiationPaymentCreateResponse>;
    createPaymentRecipient(name: string, iban?: string, address?: PaymentInitiationAddress, bacs?: RecipientBACS, cb?: Callback<PaymentInitiationRecipientCreateResponse>): Promise<PaymentInitiationRecipientCreateResponse>;
    ...
    getAccounts(access_token: string, options?: AccountsGetRequestOptions, cb?: Callback<AccountsGetResponse>): Promise<AccountsGetResponse>;
    ...
    getBalance(access_token: string, options?: AccountsGetRequestOptions, cb?: Callback<AccountsGetResponse>): Promise<AccountsGetResponse>;
    ...
    getHoldings(access_token: string, options?: InvestmentHoldingsGetRequestOptions, cb?: Callback<InvestmentsHoldingsGetRequest>): Promise<InvestmentsHoldingsGetRequest>;
    ...
    getPayment(payment_id: string, cb?: Callback<PaymentInitiationPaymentGetResponse>): Promise<PaymentInitiationPaymentGetResponse>;
    ...
    sandboxBankTransferSimulate(bank_transfer_id: string, event_type: BankTransferEventType, failure_reason?: BankTransferFailure, cb?: Callback<SandboxBankTransferSimulateResponse>): Promise<SandboxBankTransferSimulateResponse>;
    sandboxPublicTokenCreate(institution_id: string, initial_products: Array<Products>, options: SandboxPublicTokenCreateRequestOptions, cb?: Callback<SandboxPublicTokenCreateResponse>): Promise<SandboxPublicTokenCreateResponse>;
    ...
    sandboxItemSetVerificationStatus(access_token: string, account_id: string, verification_status: SandboxItemSetVerificationStatusRequestVerificationStatusEnum, cb?: Callback<SandboxItemSetVerificationStatusResponse>): Promise<SandboxItemSetVerificationStatusResponse>;
    searchInstitutionsByName(query: string, products: Array<Products>, country_codes: Array<CountryCode>, options?: InstitutionsSearchRequestOptions, cb?: Callback<InstitutionsSearchResponse>): Promise<InstitutionsSearchResponse>;
